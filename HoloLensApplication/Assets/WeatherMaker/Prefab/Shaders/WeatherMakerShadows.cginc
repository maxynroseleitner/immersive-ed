...
#define UNITY_SAMPLE_SHADOW_4(tex, coord) \
	(( \
	UNITY_SAMPLE_SHADOW(tex, (float4(coord.x - _WeatherMakerSunShadowMapTexture_TexelSize.x, coord.y - _WeatherMakerSunShadowMapTexture_TexelSize.y * 0.5, coord.z, 0.0))) + \
	UNITY_SAMPLE_SHADOW(tex, (float4(coord.x - _WeatherMakerSunShadowMapTexture_TexelSize.x * 0.5, coord.y + _WeatherMakerSunShadowMapTexture_TexelSize.y, coord.z, 0.0))) + \
	UNITY_SAMPLE_SHADOW(tex, (float4(coord.x + _WeatherMakerSunShadowMapTexture_TexelSize.x * 0.5, coord.y - _WeatherMakerSunShadowMapTexture_TexelSize.y, coord.z, 0.0))) + \
	UNITY_SAMPLE_SHADOW(tex, (float4(coord.x + _WeatherMakerSunShadowMapTexture_TexelSize.x, coord.y + _WeatherMakerSunShadowMapTexture_TexelSize.y * 0.5, coord.z, 0.0))) \
	) * 0.25)
