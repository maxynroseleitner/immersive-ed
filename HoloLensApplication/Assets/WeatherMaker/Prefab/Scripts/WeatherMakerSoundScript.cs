...
{
    [CreateAssetMenu(fileName = "WeatherMakerSound", menuName = "WeatherMaker/Sound", order = 10)]
    public class WeatherMakerSoundScript : WeatherMakerBaseScriptableObjectScript
    {
        ...
        {
            if (!Disabled && CanPlay && AudioClips != null && AudioClips.Length != 0 && (HoursOfDay.Count != 0 || (int)(WeatherMakerScript.Instance.DayNightScript.TimeOfDayCategory & TimesOfDay) != 0))
            {
