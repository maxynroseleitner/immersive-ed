...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerCloudShadowProjectorScript : MonoBehaviour
    {
        ...
        private Vector3? ProcessCloudShadowsAndGetSunCameraIntersect(Camera c)
        {
            ...
            CloudShadowProjector.orthographicSize = c.farClipPlane * WeatherMakerScript.Instance.SkySphereScript.SkySphereProfile.FarClipPlaneMultiplier;
        ...
        private void Start()
        {
            ...
            if (Application.isPlaying)
            {
                ...
                CloudShadowProjector.material = new Material(CloudShadowProjector.material);
            }
