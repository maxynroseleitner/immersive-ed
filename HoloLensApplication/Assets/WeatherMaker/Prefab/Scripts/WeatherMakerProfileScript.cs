...
{
    [CreateAssetMenu(fileName = "WeatherMakerProfile", menuName = "WeatherMaker/Weather Profile", order = 1)]
    public class WeatherMakerProfileScript : WeatherMakerBaseScriptableObjectScript
    {
        [Header("Animation")]
        [SingleLineClamp("Random range in seconds this profile takes to transition in. This will affect how long the clouds, wind, precipitation and fog take to transition.", 0f, 300.0f)]
        ...
        [Tooltip("Cloud type. Set to custom if you are setting the CloudProfile manually.")]
        ...
        [Tooltip("The fog mode.")]
        public WeatherMakerFogMode FogMode;
