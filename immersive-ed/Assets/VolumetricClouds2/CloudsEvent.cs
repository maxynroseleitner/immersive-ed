...
public class CloudsEvent : MonoBehaviour
{
    ...
    void UpdateMaterialInfo()
    {
        ...
        matInfo._PerlinNormalMap = cloudMaterial.GetTexture("_PerlinNormalMap") as Texture2D;
    }
    ...
    void OnValidate()
    {
        Texture2D _PerlinNormalMap = cloudMaterial.GetTexture("_PerlinNormalMap") as Texture2D;
