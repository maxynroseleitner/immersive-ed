...
public class SentimentAnalyzer : MonoBehaviour
{
    ...
    private void OnAnalyseResponse(AnalysisResults response, Dictionary<string, object> customData)
    {
        ...
        currentEmotions.joy = N["keywords"][0]["emotion"]["joy"];
        currentEmotions.anger = N["keywords"][0]["emotion"]["anger"];
        currentEmotions.fear = N["keywords"][0]["emotion"]["fear"];
        currentEmotions.disgust = N["keywords"][0]["emotion"]["disgust"];
        currentEmotions.sadness = N["keywords"][0]["emotion"]["sadness"];
